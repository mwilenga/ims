                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                             ...
                             $sel = $connect->query("select * from tms_loads where status = 0");
                              $num = mysqli_num_rows($sel);
                             ?>
                               <h3 class="panel-title"><i class="fa fa-list"></i>&nbsp;List of created trips &nbsp;(<?php echo $num;?>)</h3>
                              </div>                                    
                                    ...
                                    <table class = "table table-striped">
										 <tr>
											 ...
											 <tr ng-repeat = "loads in data | filter:search">
                                                 ...
                                                 <td>{{loads.date}}</td>
												 <td><a href = "assign_truck.php?id={{loads.id}}"><i class="fa fa-edit"></i>&nbsp;Assign to truck</a></td>
												 </tr>
