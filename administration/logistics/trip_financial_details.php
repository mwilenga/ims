    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">                   
                    <li>Home</li>
                    <li class="active">Trips revenue</li>
                </ul>
                <!-- END BREADCRUMB -->                
                
                <div class="page-title">                    
                    <h2><span class="fa fa-truck"></span> Trip revenue</h2>
                </div>                   
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Truck expenses details per trip (T 200 ADC) 2017</h3>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <table class = "table table-striped">
											 ...
											 <tr>
												 <td style = "width:25%">12/12/2017</td>
												 <td style = "width:50%">Accomodation and food</td>
												 <td style = "width:25%">TZS 200,000</td>
											 </tr>
											 <tr>
												 <td style = "width:25%">12/12/2017</td>
												 <td style = "width:50%">Direct payments</td>
												 <td style = "width:25%">TZS 100,000</td>
											 </tr>
											 <tr>
												 <td style = "width:25%">12/12/2017</td>
												 <td style = "width:50%">Truck services and charges</td>
												 <td style = "width:25%">TZS 100,000</td>
											 </tr>	 	 
										</table><hr/>
										<p><strong>Total expenses TZS 500,000</strong></p><hr/>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table class = "table table-striped">
											 ...
											 <tr>
												 ...
												 <td style = "width:25%">TZS 2,000,000</td>
											 </tr>	 	 
										</table><hr/>
										<p><strong>Total income TZS 2,000,000</strong></p>
										<p><strong>Revenue TZS 1,500,000 (Total Income - Total Expenses</strong></p><hr/>
										<p><strong><button class = "btn btn-default"><span class = "fa fa-print"></span> Export report</button></strong></p>
                                </div>
                            </div>
