 ...
 if(!isset($_SESSION['id'])){
  ...
  if(isset($_POST['submit'])){
   ...
   $create_auth = $fetch_data['crea_auth'];
	  ...
	  $class = strtoupper(mysqli_real_escape_string($_POST['class']));
	  ...
	  if($name == ''){
		  $er = "<div class = 'alert alert-danger flush'>Sorry fill The empty field</div>";
			 ...
			 $er = "<div class = 'alert alert-danger flush'>Sorry! You don't have previllege to create new drivers,please see system administration</div>";
	  }
	  else{
			   $in = "insert into tms_drivers values('','$name','$class','$cont')";
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-plus-circle"></i>&nbsp;Add new driver</h3>
									<span style="float:right"><i class="fa fa-eye"></i>&nbsp;<a href="drivers.php"><b>View registered drivers</b></a></span>
                                </div>
                                ...
                                <div class="panel-body">
                                  ...
                                  <div class="form-group">
                                    <label>Licence No</label>
                                            <div class="col-md-12">
                                                <input type="text" name="class" id = "name" class="form-control" placeholder=""/>
                                            </div>
                                        </div>
                                    </td>
                                    <td width="350px">
                                  <div class="form-group">
                                    <label>Contact</label>
                                            <div class="col-md-12">
                                                <input type="text" name="cont" id = "name" class="form-control" placeholder=""/>
                                            </div>
                                        </div>
                                    </td>
                                    </tr> 
