                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><i class="fa fa-edit"></i>&nbsp;Edit Customer Info</h3>
                                </div>
                                ...
                                <div class="panel-body">
                                   ...
                                   <div class="form-group">
                                    <label>Customer Name</label>
                                            <div class="col-md-12">
                                                <input type="text" name="name" value="<?php echo $rw['customer_name'];?>" class="form-control" placeholder="" required />
                                            </div>
                                        </div>
                                    </td>
                                    <td width="350px">
                                  <div class="form-group">
                                    <label>Contact</label>
                                            <div class="col-md-12">
                                                <input type="number" name="cont" value="<?php echo $rw['contact'];?>" class="form-control" placeholder="" required/>
                                            </div>
                                        </div>
                                    </td>
                                    <td width="350px">
                                  <div class="form-group">
                                    <label>Location</label>
                                            <div class="col-md-12">
                                                <input type="text" name="loc" value="<?php echo $rw['location'];?>"  class="form-control" placeholder="" required/>
                                            </div>
                                        </div>
                                    </td>
                                    </tr> 
                                    ...
                                    <div class = "row">
                                        <button class = "btn btn-primary" name="submit" style = "float:right"><i class="fa fa-plus"></i>Update</button>
