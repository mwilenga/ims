...
<head>        
                        ...
                        <div class="col-md-12">
                            ...
                            <?php 
                             ...
                             ?>
                              ...
                              <span style="float:right"><i class="fa fa-plus-circle"></i>&nbsp;<a href="add_customer.php"><b>Create new customer</b></a></span>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <table class = "table table-striped">
                                         <tr>
                                             ...
                                             <tr ng-repeat = "customers in data | filter:search">
                                                 <td>{{ customers.customer_name }}</td>
                                                 <td>{{ customers.contact }}</td>
                                                 <td>{{ customers.location }}</td>
                                                 <td><i class="fa fa-edit"></i>&nbsp;<a href="edit_customer.php?id={{customers.id}}">edit</a>&nbsp;|&nbsp;<i class="fa fa-trash-o"></i>&nbsp;<a href="delete_customer.php?id={{customers.id}}" onclick="return confirm('Are you sure?');">delete</a></td>
                                                 </tr>
    ...
    <!-- START SCRIPTS -->
        ...
        $scope.display_data = function(){
            $http.get("display_customers.php")
