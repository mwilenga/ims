                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <tr>
                             ...
                             <td>
                              <span style="float:right"><i class="fa fa-plus-circle"></i>&nbsp;<a href="add_user.php"><b>Add new user</b></a> | <i class="fa fa-edit"></i><a href="user_permisions.php"><b>&nbsp;User privillege</b></a></span>
                             </td>
                            </tr>
                            </table>
                             </div>
                                    ...
                                    <table class = "table table-striped">
                                         <tr>
                                             ...
                                             <tr ng-repeat = "user in data | filter:search">
                                                 ...
                                                 <td>{{ user.username }}</td>
                                                 <td>{{ user.role }}</td>
                                                 <td><i class="fa fa-edit"></i>&nbsp;<a href="edit_user.php?id={{user.id}}">edit</a>&nbsp;|&nbsp;<i class="fa fa-trash-o"></i>&nbsp;<a href="delete_user.php?id={{user.id}}" onclick="return confirm('Are u sure?');">delete</a></td>
                                                 </tr>
